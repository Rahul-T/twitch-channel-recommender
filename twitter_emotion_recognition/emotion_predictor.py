...
class EmotionPredictor:
    ...
    def _get_model(self):
        self._loaded_model_filename = os.getcwd() + '/twitter_emotion_recognition/models/{}{}-{}.h5'.format(
    ...
    def _get_char_mapping():
        with open(os.getcwd() + '/twitter_emotion_recognition/models/allowed-chars.pkl', 'rb') as f:
